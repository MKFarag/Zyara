...
public record UserErrors
{
    ...
    public static readonly Error InvalidCredentials =
        new("User.InvalidCredentials", "Invalid email/username/password", StatusCodes.Status401Unauthorized);
    ...
    public static readonly Error DuplicatedUserName =
        new("User.DuplicatedUserName", "Another user with the same username is already exists", StatusCodes.Status409Conflict);
